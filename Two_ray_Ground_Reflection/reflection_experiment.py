from Two_ray_Ground_Reflection.two_ray_ground_reflection_model import trgr_model
...
_, amp_0f_5_sim, phase_0f_5_sim = trgr_model((29.71592, -95.40925), (29.71604, -95.40833), 5, 8, 0.039446375, 1.524,
                                             h_RX, 0.039446375, 0.08327568, 95, 70, e_r)
...
# Amplitude & phase (simulation) : 4 antennas
_, amp_0b_5_sim, phase_0b_5_sim = trgr_model((29.71592, -95.40938), (29.71604, -95.40833), 5, 8, 0.039446375, 1.524,
                                             h_RX, 0.039446375, 0.08327568, 95, 70, e_r)
...
# Amplitude & phase (simulation) : 4 antennas
_, amp_10f_5_sim, phase_10f_5_sim = trgr_model((29.716, -95.40925), (29.71604, -95.40833), 5, 8, 0.039446375, 1.524,
                                               h_RX, 0.039446375, 0.08327568, 95, 70, e_r)
...
# Amplitude & phase (simulation) : 4 antennas
_, amp_10b_5_sim, phase_10b_5_sim = trgr_model((29.716, -95.40938), (29.71604, -95.40833), 5, 8, 0.039446375, 1.524,
                                               h_RX, 0.039446375, 0.08327568, 95, 70, e_r)
...
# Amplitude & phase (simulation) : 4 antennas
_, amp_20f_5_sim, phase_20f_5_sim = trgr_model((29.71608, -95.40925), (29.71604, -95.40833), 5, 8, 0.039446375, 1.524,
                                               h_RX, 0.039446375, 0.08327568, 95, 70, e_r)
...
# Amplitude & phase (simulation) : 4 antennas
_, amp_20b_5_sim, phase_20b_5_sim = trgr_model((29.71608, -95.40938), (29.71604, -95.40833), 5, 8, 0.039446375, 1.524,
                                               h_RX, 0.039446375, 0.08327568, 95, 70, e_r)
